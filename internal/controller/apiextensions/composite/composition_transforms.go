...
const (
	...
	errFmtTransformAtIndex              = "transform type %q at index %d returned error"
	...
	errFmtMatchPattern            = "cannot match pattern with type %q at index %d"
	errFmtMatchParseResult        = "cannot parse result of pattern type %q at index %d for match transform"
